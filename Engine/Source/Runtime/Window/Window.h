...
public:
    ...
    void CreateVulkanSurfaceKHR(VkInstance instance, const VkAllocationCallbacks* allocator, VkSurfaceKHR *p_surface)
      {
    ...
    void *GetNativeWindow() { return handle; }
    int GetKey(int key);
    ...
    void SetWindowCloseCallbacks(PFN_WindowCloseCallback callback);
    void SetWindowResizeCallbacks(PFN_WindowResizeCallback callback);
    void SetWindowMouseButtonCallbacks(PFN_WindowMouseButtonCallback callback);
    void SetWindowCursorPositionCallbacks(PFN_WindowCursorPositionCallback callback);
    void SetWindowKeyCallbacks(PFN_WindowKeyCallback callback);
    void SetWindowScrollCallbacks(PFN_WindowScrollCallback callback);
