...
void Window::SetWindowCloseCallbacks(PFN_WindowCloseCallback callback)
{
...
void Window::SetWindowResizeCallbacks(PFN_WindowResizeCallback callback)
{
...
void Window::SetWindowMouseButtonCallbacks(PFN_WindowMouseButtonCallback callback)
{
...
void Window::SetWindowCursorPositionCallbacks(PFN_WindowCursorPositionCallback callback)
{
...
void Window::SetWindowKeyCallbacks(PFN_WindowKeyCallback callback)
{
...
void Window::SetWindowScrollCallbacks(PFN_WindowScrollCallback callback)
{
